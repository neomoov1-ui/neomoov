...
Le worker signale une course figée (arrivé depuis plus de 30 minutes, en route depuis plus de 90, en course depuis plus de 4 heures, réservation en retard de 15 minutes, recherche au-delà de 20 minutes). La liste existe dans l'API (`GET /v1/admin/rides/stuck`) mais **aucun écran de My Hub ne l'affiche encore**, et l'alerte part en notification push au personnel, qui n'a pas d'appareil enregistré. En attendant : Courses, vue « Répartition », trier du regard par heure de prise en charge. Signalé comme manque au code.
