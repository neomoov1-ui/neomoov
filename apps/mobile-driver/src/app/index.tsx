...
/**
 * Démarrage : logo, promesse chauffeur, langue. Une session ouverte mène à l'accueil chauffeur, ou à la candidature si
 * le compte n'a pas encore le rôle chauffeur.
 */
export default function StartScreen() {
  ...
  if (status === 'signedIn') return <Redirect href={isDriver ? '/home' : '/apply'} />;
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <Card style={styles.card}>
        <Body>{t('core:slogan')}</Body>
      </Card>
      <View style={styles.actions}>
        <Button label={t('start')} onPress={() => router.push('/login')} testID="start" />
