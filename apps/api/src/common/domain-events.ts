...
export interface DomainEvents {
  ...
  /** Course en cours interrompue par l'exploitation : autorisation de paiement levée, décision humaine sur l'incident. */
  'ride.interrupted': RideEventPayload & { incidentId: string };
