 ...
 * Jamais de chaîne codée en dur dans les composants.
 */
...
export const resources = {
  'fr-CA': {
    translation: {
      ...
      nav: { home: 'Accueil', hub: 'My Hub', book: 'Réserver', language: 'Langue' },
      home: {
      ...
      hub: { title: 'My Hub Neomoov', locked: 'Accès réservé aux opérateurs. Connectez-vous pour continuer.', login: 'Se connecter', placeholder: 'La connexion sécurisée arrive à l\'étape 3 du cahier des charges.' },
  ...
  en: {
    translation: {
      ...
      nav: { home: 'Home', hub: 'My Hub', book: 'Book', language: 'Language' },
      home: {
      ...
      hub: { title: 'Neomoov My Hub', locked: 'Operators only. Sign in to continue.', login: 'Sign in', placeholder: 'Secure sign-in arrives at step 3 of the specification.' },
