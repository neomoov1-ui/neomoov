...
/**
 * Étape 2 : code à 6 chiffres. L'acceptation des conditions et de la politique en vigueur est demandée à chaque fois :
 * l'API ne dit pas avant le code si le numéro a déjà un compte (pas d'énumération des comptes), et l'ignore s'il existe.
 */
export default function VerifyScreen() {
  ...
  async function verify() {
    ...
    try {
      ...
      router.replace(tokens.created ? '/consents' : '/book');
    } catch (e) {
